...
/**
 * Test d'intégration bout-en-bout de l'authentification (T-04), contre la
 * base PostgreSQL locale migrée par Flyway (schéma + données de démonstration
 * {@code R__identite_comptes_demo.sql}). Nécessite {@code docker compose up
 * -d} au préalable (voir docs/SETUP-WINDOWS.md) — même limite documentée que
 * {@code DemoEntiteControllerIntegrationTest} (T-08 apportera Testcontainers).
 *
