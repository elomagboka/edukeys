...
public enum CodeErreur {
    ...
    // Structure académique (US-02) : cycles
    CYCLE_INTROUVABLE,
    CYCLE_LIBELLE_DUPLIQUE,
    CYCLE_RANG_DUPLIQUE,
    CYCLE_CODE_DUPLIQUE,
    CYCLE_NON_DESACTIVABLE,

    // Structure académique (US-02) : niveaux
    NIVEAU_INTROUVABLE,
    NIVEAU_LIBELLE_DUPLIQUE,
    NIVEAU_RANG_DUPLIQUE,
    NIVEAU_CODE_DUPLIQUE,
    NIVEAU_NON_DESACTIVABLE,

    // Structure académique (US-02) : filières
    FILIERE_INTROUVABLE,
    FILIERE_LIBELLE_DUPLIQUE,
    FILIERE_CODE_DUPLIQUE,
    FILIERE_NON_DESACTIVABLE,
    FILIERE_CYCLE_INCOHERENT,

    // Structure académique (US-02) : classes
    CLASSE_INTROUVABLE,
    CLASSE_LIBELLE_DUPLIQUE,
    CLASSE_LIBELLE_VIDE,
    CLASSE_EFFECTIF_MAX_INVALIDE,
    CLASSE_ANNEE_CLOTUREE,
    CLASSE_SITE_INVALIDE,
    CLASSE_REFERENTIEL_INACTIF,

    // Matières (US-03)
    MATIERE_INTROUVABLE,
    MATIERE_LIBELLE_DUPLIQUE,
    MATIERE_CODE_DUPLIQUE,
    MATIERE_INACTIVE,
    MATIERE_AFFECTATION_CLE_DUPLIQUEE,
    MATIERE_AFFECTATION_INCOHERENTE,

    // Périodes académiques (US-05)
    PERIODE_ACADEMIQUE_INTROUVABLE,
    PERIODE_ACADEMIQUE_EN_COURS_ABSENTE,
    PERIODE_ACADEMIQUE_ANNEE_SCOLAIRE_INTROUVABLE,
    PERIODE_ACADEMIQUE_DATES_INCOHERENTES,
    PERIODE_ACADEMIQUE_DUREE_INVALIDE,
    PERIODE_ACADEMIQUE_HORS_BORNES_ANNEE,
    PERIODE_ACADEMIQUE_LIBELLE_DUPLIQUE,
    PERIODE_ACADEMIQUE_ORDRE_DUPLIQUE,
    PERIODE_ACADEMIQUE_PERIODE_CHEVAUCHANTE,
    PERIODE_ACADEMIQUE_ANNEE_CLOTUREE,
    PERIODE_ACADEMIQUE_IMMUABLE,
